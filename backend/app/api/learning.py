...
from backend.app.core.database import (
    ...
    update_reading_progress, get_completed_sections, get_subject_reading_progress,
    get_subject_mastery_dict, get_book_pyq_counts, get_subject_practice_solved_dict, get_subject_board_passed_dict
)
from backend.app.services.adaptive import (
    get_simplify_explanation_stream
)
from backend.app.services.subject_catalog import get_subject_catalog

# Import Pydantic schemas
from backend.app.schemas.learning import MarkReadRequest
