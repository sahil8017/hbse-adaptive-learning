...
import httpx
from fastapi import APIRouter, Request, HTTPException, UploadFile, File, Depends, Form, status, Response
...
from backend.app.services.adaptive import (
    ...
    get_tutor_chat_stream, get_practice_hint_stream, get_practice_chat_stream,
